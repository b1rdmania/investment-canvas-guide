...
const Pages = [
  // Page 1: Logo Page with Tagline
  <div key="1" className="flex flex-col items-center justify-center h-full space-y-12 bg-brand-white">
    <img 
  ...
  <div key="2" className="space-y-12 flex flex-col h-full">
